				...
				<div class="col-md-12  noPadding">
                    ...
                    try{
                                ...
                                status=request.getParameter("status");
                                                    ...
                                                    if(status.equals("0"))
                                                    {
                                                        out.println("<div class='label label-success' style='font-size: 15px;'>Notification deleted successfully!</div><br><br>");
                                                    }
                    ...
                    %>
                                    ...
                                    <tr><th>Title</th><th>Description</th><th align="right">Action</th></tr>
                                                    <%
                    ...
                    try{
                                ...
                                status=request.getParameter("status");
                                                    ...
                                                    if(status.equals("1"))
                                                    {
                                                        out.println("<div class='label label-success' style='font-size: 15px;'>Notification added successfully!</div><br><br>");
                                                    }
                    ...
                    %>
                                                    ...
                                                    <div class="col-md-10">
                                                    <h3 align="left">Add Notification</h3><br>
                                                    
                                                    <form class="row login_form bgfrom" action="includes/WebService.jsp" method="post" >
                                                                <input type="hidden" name="action" value="addnews"/>
                                                                    <div class="form-group label-floating">
                                                                            <label class="control-label">Title</label>
                                                                            <input class="form-control myInputFooter" id="msg_subject" type="text" name="title" required data-error="">
