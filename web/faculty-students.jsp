					...
					<div class="row">
						...
						<div class="col-md-10">
                                                   ...
                                                   <div class="col-md-12">
                                                    ...
                                                    <h3 align="left">Student Attendance</h3><br>
                                    ...
                                    <tr><th>Student Name</th><th>Attendance</th><th align="right">Action</th></tr>
                                                    <%
                                ...
                                try{
                                    ...
                                    ResultSet rs=db.getStudentsAttendance(id,date);
                                    while(rs.next()){
                                        ResultSet strud=db.getStudentById(rs.getInt("student_id"));
                                        if(strud.next()){
                                    %>
                                   
                                        <tr>
                                            <td align="left"><%=strud.getString("name")%> 
                                        ...
                                        <td>
                                             ...
                                             <form class="row login_form" action="includes/WebService.jsp" onchange="return this.submit();" method="post" >
                                                 <input type="hidden" value="changestudstatus" name="action" />
