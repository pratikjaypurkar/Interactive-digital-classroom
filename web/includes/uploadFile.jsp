...
//    out.println(contentType);
    if((contentType!=null) && (contentType.indexOf("multipart/form-data")>=0)){
        ...
        //out.println(file);
        //out.println(endPos);
        String saveFile1="C:/Users/jaypu/OneDrive/Documents/NetBeansProjects/digital-classroom/web/uploads/files/"+saveFile;
        ...
        try{
            ...
            int res=db.update_delete("insert into faculty_files (faculty_id,file,name,subject,year,semester,branch) values("+mid+",'"+saveFile+"','"+name+"','"+subject+"','"+year+"','"+semester+"','"+branch+"')");
            if(res>0){
                response.sendRedirect("../faculty-files.jsp?status=22");
            }else{
