					...
					<div class="row">
						...
						<div class="col-md-10">
                                ...
                                try{
                                    ...
                                    String year=rss.getString("year");
                                    String semester=rss.getString("semester");
                                    String branch=rss.getString("branch");
                                    ResultSet rs=db.getFileForStudent(year,semester,branch);
                                    while(rs.next()){
                                    %>
                                        ...
                                        <td align="left"><a href="uploads/files/<%=rs.getString("file")%>" target="_blank">Download</a></td>
                                    </tr>
                                    <%
