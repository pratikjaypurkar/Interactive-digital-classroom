				...
				<div class="col-md-12  noPadding text-center">
                    ...
                    try{
                                ...
                                status=request.getParameter("status");
                                                    ...
                                                    if(status.equals("2"))
                                                    {
                                                        out.println("<div class='label label-success' style='font-size: 15px;'>Faculty deleted successfully!</div><br><br>");
                                                    }
                    ...
                    %>
                                                    ...
                                                    <br>
                                                    <a href="admin-faculty-add.jsp" class="pull-right btn btn-primary">Add Faculty</a>
                                                    <h3 align="left">Faculties</h3>
                                                    
                                                    <table class="table bgfrom" style="width:100%">
                                    <tr><th>Name</th><th>ID</th><th>Email</th><th align="right">Action</th></tr>
                                                    <%
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                             ...
                                             <form class="row login_form" action="includes/WebService.jsp" onsubmit="return confirm('Are you sure?');" method="post" >
                                                    ...
                                                    <a href="admin-faculty-edit.jsp?facid=<%=rs.getInt("id")%>" class="btn btn-primary btn-sm">Edit</a>
