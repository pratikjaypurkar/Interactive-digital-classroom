				...
				<div class="col-md-12  noPadding">
                    ...
                    try{
                                ...
                                status=request.getParameter("status");
                                                    ...
                                                    if(status.equals("0"))
                                                    {
                                                        out.println("<div class='label label-success' style='font-size: 15px;'>File deleted successfully!</div><br><br>");
                                                    }
                    ...
                    %>
                                ...
                                try{
                                    ...
                                    ResultSet rs=db.getFacultyFiles(id);
                                    while(rs.next()){
                                    %>
                    ...
                    %>
                                                    ...
                                                    <form class="row login_form bgfrom" action="includes/WebService.jsp" method="post" >
                                                            ...
                                                            <form class="row login_form" action="includes/uploadFile.jsp?name=<%=request.getParameter("name")%>&subject=<%=request.getParameter("subject")%>&year=<%=request.getParameter("year")%>&semester=<%=request.getParameter("semester")%>&mid=<%=session.getAttribute("facultylogin")%>" enctype="multipart/form-data" method="post" >
                                                                   <div class="form-group label-floating">
