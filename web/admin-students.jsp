				...
				<div class="col-md-12  noPadding text-center">
                    ...
                    try{
                                ...
                                status=request.getParameter("status");
                                                    ...
                                                    if(status.equals("2"))
                                                    {
                                                        out.println("<div class='label label-success' style='font-size: 15px;'>Student deleted successfully!</div><br><br>");
                                                    }
                    ...
                    %>
                                    ...
                                    <tr><th>Name</th><th>EnrollNo</th><th>Email</th><th align="right">Action</th></tr>
                                                    <%
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                             ...
                                             <form class="row login_form" action="includes/WebService.jsp" onsubmit="return confirm('Are you sure?');" method="post" >
                                                    ...
                                                    <a href="admin-student-details.jsp?studid=<%=rs.getInt("id")%>" class="btn btn-primary btn-sm">Details</a>
